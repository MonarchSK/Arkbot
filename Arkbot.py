...
async def get_or_create_bump_channel(guild):
    """Fetches or automatically creates a single dedicated #bump channel."""
...
async def on_ready():
    ...
    # Initialize bump channel for connected guilds
...
async def setup_bump(ctx):
    """Creates or links the single dedicated bump channel."""
...
async def bump(ctx):
    ...
    # Restrict command execution strictly to the dedicated bump channel
